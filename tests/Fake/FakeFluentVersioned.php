...
use SilverStripe\Forager\Extensions\SearchServiceExtension as BaseSearchExtension;
 ...
 * @mixin Versioned
 */
class FakeFluentVersioned extends DataObject implements TestOnly
{

    private static string $table_name = 'FakeFluentVersioned';

    private static array $extensions = [
        BaseSearchExtension::class,
        Versioned::class,
